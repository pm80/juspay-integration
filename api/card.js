console.log('Calling Juspay Card Setup..')
card_payment_form =  Juspay.Setup({
        payment_form: "#payment_form",
        success_handler: function(status) {
            console.log('payment_form -> success_handler:', status)
        },
        error_handler: function(error_code, error_message, bank_error_code, bank_error_message, gateway_id) {
            console.log('payment_form -> error_handler:', error_code, error_message, bank_error_code, bank_error_message, gateway_id)
        },
        iframe_elements: {
            card_number: {
        ...
        iframe_element_callback: function(event) {
             ...
             */
             console.log('iframe_element_callback : ', event)
        }
    })
console.log('Juspay Card Setup complete..')